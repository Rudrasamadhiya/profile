...
const projects: Project[] = [
  ...
  },
  {
    ...
    n: '04',
    name: 'POS System',
    tagline: 'Deployed full-stack Java POS + inventory',
    category: 'Java · PostgreSQL · Full-Stack',
    problem:
      'A multi-tenant point-of-sale & inventory platform built in pure object-oriented Java — no frameworks — with a web dashboard, REST API, and CLI, deployed live on a PostgreSQL database.',
    bullets: [
      'Web dashboard + REST API served by the JDK’s built-in HttpServer (zero frameworks), plus an interactive CLI, all over one shared service layer.',
      'Transactional billing engine with server-side stock validation and rollback to prevent overselling under concurrent sales.',
      'Pluggable persistence swapping CSV ↔ PostgreSQL (JDBC) behind one Repository interface; Dockerised and deployed on Render, with GitHub Actions CI testing both backends.',
    ],
    stack: ['Java', 'PostgreSQL', 'JDBC', 'REST API', 'Docker', 'CI/CD'],
    icon: Receipt,
    accent: '#be4c00',
